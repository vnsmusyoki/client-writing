                ...
                <div class="tab-pane fade show active customerorders" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    <div class="topcontent">
                        <div class="lefttopcontent">
                            <h5>All Pending Tasks <span>({{ $tasks->count()}})</span></h5>
                        </div>
                    ...
                    <div class="bottomcontent">
                        ...
                        <div class="topbottomcontent">
                            ...
                            <h5>Nothing Here</h5>
                            <p>COntains all existing jobs you have uploaed but not send them admin. this lists lasts only for 24 Hours</p>
                        </div>
                        @endif
